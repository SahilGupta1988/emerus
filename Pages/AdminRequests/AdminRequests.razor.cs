...
namespace Emerus.ETM.Admin.Pages.AdminRequests
{
    public partial class AdminRequests : ComponentBase
    {
        public record AdminRequestRow(Guid Id, string ContractorName, string VendorName, string Facility, DateTime StartDate, string Status, DateTime CreatedAt, string? Comments);

        // populated from database on initialization
        private List<AdminRequestRow> AllRows { get; set; } = new();
        ...
        {
            // Load only requests with Status = "Submitted"
        ...
        private IEnumerable<AdminRequestRow> FilteredRows => AllRows
            .Where(r =>
        ...
        private IEnumerable<AdminRequestRow> PagedRows
        {
            get
            {
